    ...
    (async () => {
      try {
        ...
        if (res.ok) {
          ...
          router.push('/super-admin/my-jobs');
        }
      } finally {
        setFetching(false);
      }
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-4xl mx-auto pb-12">
      <div className="flex items-center gap-3">
        <Link href="/super-admin/my-jobs"><Button variant="ghost" size="sm" className="gap-1.5"><ArrowLeft className="w-4 h-4" /> Back</Button></Link>
      ...
      <div className="flex justify-end gap-3">
        <Link href="/super-admin/my-jobs"><Button variant="outline" className="rounded-xl">Cancel</Button></Link>
