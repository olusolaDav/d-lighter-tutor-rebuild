...
D-lighter Tutor Team`;
  ...
  async sendAdminApplicationNotificationEmail(options: {
    positionTitle: string;
    candidateName: string;
    candidateEmail: string;
    ...
    const { positionTitle, candidateName, candidateEmail, candidatePhone, dashboardUrl } = options;
    const subject = `New Application: ${positionTitle} — ${candidateName}`;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#1e3a5f 0%,#2d5a87 100%);padding:28px 32px;text-align:center;">
              <p style="margin:0;font-size:13px;color:rgba(255,255,255,0.75);text-transform:uppercase;letter-spacing:1px;">D-lighter Tutor</p>
              <h1 style="margin:6px 0 0;font-size:22px;font-weight:700;color:#ffffff;">New Job Application</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px;">
              <p style="margin:0 0 6px;font-size:15px;color:#374151;">Hi Admin,</p>
              <p style="margin:0 0 24px;font-size:14px;color:#6b7280;">A new application has been submitted for the <strong>${positionTitle}</strong> position. Here are the applicant's details:</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:8px;margin-bottom:24px;">
                <tr>
                  <td style="padding:16px 20px;border-bottom:1px solid #e5e7eb;">
                    <p style="margin:0 0 2px;font-size:11px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Applicant</p>
                ...
                <tr>
                  <td style="padding:12px 20px;border-bottom:1px solid #e5e7eb;">
                    <p style="margin:0 0 2px;font-size:11px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Email</p>
                    <p style="margin:0;font-size:14px;color:#1e3a5f;"><a href="mailto:${candidateEmail}" style="color:#1e3a5f;text-decoration:none;">${candidateEmail}</a></p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 20px;border-bottom:1px solid #e5e7eb;">
                    <p style="margin:0 0 2px;font-size:11px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Phone</p>
                    <p style="margin:0;font-size:14px;color:#374151;">${candidatePhone || 'Not provided'}</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 20px;">
                    <p style="margin:0 0 2px;font-size:11px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Position Applied For</p>
                    <p style="margin:0;font-size:14px;font-weight:600;color:#374151;">${positionTitle}</p>
                  </td>
                </tr>
              </table>

              <p style="margin:0 0 4px;font-size:12px;color:#9ca3af;">Received: ${receivedAt}</p>

              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                <tr>
                  <td align="center">
                    <a href="${dashboardUrl}"
                       style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#1e3a5f 0%,#2d5a87 100%);color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:8px;letter-spacing:0.3px;">
              ...
              <p style="margin:20px 0 0;font-size:13px;color:#9ca3af;text-align:center;">
                Or visit: <a href="${dashboardUrl}" style="color:#1e3a5f;">${dashboardUrl}</a>
              </p>
            </td>
          </tr>
          <tr>
